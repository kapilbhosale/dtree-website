  ...
  return (
    <div className="container mx-auto px-6 py-12">
      <div className="max-w-3xl mx-auto bg-white p-8 rounded-lg shadow">
        <h1 className="text-2xl font-bold mb-6">Privacy Policy of Dtree Labs LLP</h1>
        <p className="mb-4">
          Dtree Labs LLP operates the <strong>https://dtreelabs.com</strong> website, which provides the SERVICE.
        </p>
        <p className="mb-4">
          This page is used to inform website visitors regarding our policies with the collection, use, and disclosure of Personal Information if anyone decides to use our Service, the <strong>Website Name</strong> website.
        </p>
        <p className="mb-4">
          If you choose to use our Service, then you agree to the collection and use of information in relation to this policy. The Personal Information that we collect is used for providing and improving the Service. We will not use or share your information with anyone except as described in this Privacy Policy.
        </p>
        <p className="mb-4">
          The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which are accessible at <a href="Website URL" className="text-blue-500 underline">Website URL</a>, unless otherwise defined in this Privacy Policy.
        </p>
